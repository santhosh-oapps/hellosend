...
import pipedriveChannel from "../../img/Partner/pipedriveChannel.png"
...
const PipedriveHeaderPage = () => (
        ...
        <Col xl={24} md={24} xs={24}>
            <Row style={{padding:'50px', border:"1px solid black", borderRadius:"50px"}}>
                <Col align='center' xl={12} md={24} xs={24}>
                    <img  src={pipedrivePartner} alt="Image1" className="block-image"  style={{width: "25%"}} />
                    <Title style={{textAlign:"left", paddingTop:'30px'}} level={3}>SMS for Pipedrive</Title>
                    <List
                      dataSource={dataZoho}
    ...
    />
                ...
                <Col justify="center" align="middle" style={{paddingTop:"125px"}} xl={11} md={24} xs={24}><img  src={pipedriveChannel} alt="Image1" style={{width:"50%", height:"auto"}}  /></Col>
            </Row>
        </Col>
  ...
  export default PipedriveHeaderPage;
