...
import pipedriveShopify from "../../img/Partner/shopify.png"
...
const ShopifyHeaderPage = () => (
        ...
        <Col xl={24} md={24} xs={24}>
            <Row style={{padding:'50px', border:"1px solid black", borderRadius:"50px"}}>
                <Col align='center' xl={12} md={24} xs={24}>
                    <img  src={pipedriveShopify} alt="Image1" className="block-image"  style={{width: "25%"}} />
                    <Title style={{textAlign:"left", paddingTop:'30px'}} level={3}>SMS for Shopify</Title>
                    <List
                      dataSource={dataZoho}
  ...
  export default ShopifyHeaderPage;
