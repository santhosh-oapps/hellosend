...
const ZohoDeskOmniApps= () => {
    
    const data = [
        {
          title: 'Inbound and outbound SMS/MMS: Send inbound and outbound SMSs/MMSs that will be recorded as tickets and threads inside Zoho Desk.',
        },
        {
      ...
      return (<>
        ...
        <div className="zoho-types" style={{backgroundColor:"floralwhite"}}>
        <Blob/>
        <Row style={{padding:'2%', textAlign:'left'}}>
          <Row align={'center'}>
        <Title  level={2}>Zoho Desk - Instant Messenger</Title>
            <Text type="secondary">Streamline customer interactions and optimize support team efficiency with this versatile SMS extension for Zoho Desk. Seamlessly integrate SMS capabilities into your platform, empowering your team to engage with customers through text messages, ensuring prompt assistance and a comprehensive customer service experience.</Text>
                </Row>
            ...
            <Col xl={10} md={24} xs={24} offset={2}>
              ...
              <List
                ...
                renderItem={(item, index) => (
                    ...
                    />
              <Button className='partnerButton' target='_blank' href='https://marketplace.zoho.com/app/desk/instant-messenger-for-zoho-desk' align="center" type="primary">Go to start free trail</Button>
            </Col>
        </Row>
        </div>
        </div>
...
export default ZohoDeskOmniApps