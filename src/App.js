...
import PartnerZoho from "./components/ZohoOAppS/PartnerZoho";
import PartnerPipedrive from "./components/PipedriveOAppS/PartnerPipedrive";
import PartnerShopify from "./components/ShopifyOAppS/PartnerShopify";
import PartnerHubspot from "./components/HubspotOAppS/PartnerHubspot"
...
const AllPages = () => {
  ...
  console.log(lastPathSegment,'page');
 ...
 else if(lastPathSegment == "contact-us"){
  return (
    <>
      <NavBarTop />
      <Contacts />
 ...
 else if(lastPathSegment == "our-integrations"){
  return (
    <>
      <NavBarTop />
      <PortfolioAllCardsShow />
    </>
  );
 }
  else{
